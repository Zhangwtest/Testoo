...
public class Ground : MonoBehaviour
{
    ...
    void BornObstacle()
    {
        ...
        {
            case 0:
                Vector3 newPos_1 = new Vector3(Random.Range(-9,9), 2.8f, 0);
                Instantiate(obstacle, newPos_1, Quaternion.identity);
                break;
            case 1:
                Vector3 newPos_2 = new Vector3(Random.Range(-9, 9), 1.0f, 0);
                Instantiate(obstacle, newPos_2, Quaternion.identity);
                break;
            case 2:
                Vector3 newPos_3 = new Vector3(Random.Range(-9, 9), -1.0f, 0);
                Instantiate(obstacle, newPos_3, Quaternion.identity);
                break;
            case 3:
                Vector3 newPos_4 = new Vector3(Random.Range(-9, 9), -2.8f, 0);
